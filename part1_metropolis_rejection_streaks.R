# Άσκηση 1
# Metropolis με κανονική πρόταση N(0,1) (τυχαίος περίπατος)
# Υπολογισμός run-lengths απορρίψεων
